/*
 * NewVFIJ2SEProjectWizardPanel2.java
...
public class NewVFIJ2SEProjectWizardPanel2 implements WizardDescriptor.Panel<WizardDescriptor> {

	/**
	 * The visual component that displays this panel. If you need to access the
	 * component from this class, just use getComponent().
	 */
	private NewVFIJ2SEProjectVisualPanel2 component;
	...
	@Override
	public NewVFIJ2SEProjectVisualPanel2 getComponent() {
		if (component == null) {
			component = new NewVFIJ2SEProjectVisualPanel2();
		}
		return component;
	}
